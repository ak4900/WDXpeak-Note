...
![csapp1.1](./image/csapp1.1.jpg)

hello.c 程序以字节序列的方式存储在文件中。每个字节都有一个整数值，而该整数值对应于某个字符。

![csapp1.2](./image/csapp1.2.jpg)
...
![csapp2.8](./image/csapp2.8.jpg)

![csapp2.9](./image/csapp2.9.jpg)

![csapp2.10](./image/csapp2.10.jpg)
...
![csapp2.17](./image/csapp2.17.jpg)

#### 2.2.5 C 语言中的有符号数与无符号数

C 语言允许无符号数和有符号数之间的转换。转换的原则是底层的位表示保持不变。

![csapp2.18](./image/csapp2.18.jpg)
...
![csapp2.31](./image/csapp2.31.jpg)

![csapp2.32](./image/csapp2.32.jpg)

#### 2.4.3 数字示例

![csapp2.33](./image/csapp2.33.jpg)

![csapp2.34](./image/csapp2.34.jpg)
...
![csapp3.8](./image/csapp3.8.jpg)

#### 3.5.5 特殊的算术操作

![csapp3.9](./image/csapp3.9.jpg)	
...
![csapp0.4](./image/csapp0.4.jpg)	

![csapp3.10](./image/csapp3.10.jpg)	
...
![csapp3.16](./image/csapp3.16.jpg)	

这个机制和分支预测紧密相关。

![csapp3.17](./image/csapp3.17.jpg)	
...
![csapp3.24](./image/csapp3.24.jpg)	

#### 3.7.5 递归过程

![csapp3.25](./image/csapp3.25.jpg)	

![csapp3.27](./image/csapp3.27.jpg)	
...
![csapp0.7](./image/csapp0.7.jpg)	

#### 3.8.4 定长数组

C 语言编译器能够优化定长多维数组上的操作代码。

![csapp3.28](./image/csapp3.28.jpg)	

#### 3.8.5 变长数组

![csapp3.29](./image/csapp3.29.jpg)	
