...
学习笔记、读书笔记。
创作
包括灵感归纳、文学类、产品设计类、博客文、草稿等。
工作
一切和工作相关，把经常使用的工作笔记和存档类工作笔记分开，会大大提升效率。
备忘
随手记录，便签。
思路
思路的整理和记录，可直接把思维导图文件保存到笔记里。
规划
想到什么不一定要立刻就做，先把它丢进规划里，慢慢梳理。想看的电影，想玩的游戏，想去玩的地方，还有你的书单等等统统丢进来。用笔记保存todolist也是很快捷高效的。

抛砖引玉。以上。



所以现在记的笔记都很零碎，所以从四个纬度来管理笔记，主要是为了复习方便。
...
1. 打分，给每一篇笔记打分，1-3分，3分是要多看，2分是已掌握，1分是仅保存。分数是可以调整的，3分的文章看了很多次后，就可以改为2分，已经掌握的2分就改为1分。

这个纬度经常用，我规定每天看三篇3分的笔记，两篇2分的笔记，一篇1分的笔记。

2. 阅读次数，上面说过，主要是为了复习，所以每篇笔记都要写上阅读次数。用abcdefg……来标记，记笔记时记下a，复习时把a改成b，把b改成c这样的

3. 分类，分成经济、历史、哲学等等的大类别，就是加上标签啦。

这个纬度现在还很少用。也许以后资料多了会用到。

4. 关键词，给笔记加上关键词。比如鸟群中的鸟为什么不会相撞的笔记中讲到了自组织，就加上 自组织 的标签。

这个经常用，查资料很方便。

以上就是我的零碎笔记系统，零碎笔记全放在一个目录下，以文件名排序。

类似这样：@3c科学自组织，鸟群中的鸟为什么不会相撞？.md

markdown格式，es文件夹管理，我不用笔记app。
